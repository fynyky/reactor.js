...
(function() {
  var CompoundError, CustomSet, OBSERVER, SIGNAL, dependencyStack, global,
  ...
  global.Signal = function(definition) {
    ...
    signalCore = {
      ...
      read: function() {
        var dependent, firstNullIndex, signalError;
        dependent = dependencyStack[dependencyStack.length - 1];
        if (dependent != null) {
          if (__indexOf.call(this.dependents, dependent) < 0) {
            firstNullIndex = this.dependents.indexOf(null);
            if (firstNullIndex >= 0) {
              this.dependents[firstNullIndex] = dependent;
            } else {
