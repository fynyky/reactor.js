...
(function() {
  ...
  global.Signal = function(definition) {
    ...
    createdSignal = function(newDefinition) {
      var dependent, existingDependencyIndex, existingDependentIndex, existingObserveeIndex, existingObserverIndex, methodName, observerList, observerTrigger, _fn, _i, _j, _len, _len1, _ref;
